...
# run zdns by inputting the domain names
...
def get_IPs_from_actual_line(actual_line):
...
def verify_output(stdout):
    # parse the output of zdns
    ...
    for line in output_lines:
        ...
        actual_ips = set(get_IPs_from_actual_line(actual_line))

        assert set(actual_ips) == set(expected_test_data_lookup_domain_to_IPs[actual_domain]), (
