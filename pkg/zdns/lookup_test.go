...
var protocolStatus = make(map[domain_ns]Status)
...
//	nsMod.Init(lookupIpv4, lookupIpv6)
//
//	ns1 := net.JoinHostPort(config.ExternalNameServers[0], "53")
//	domain1 := "example.com"
...
//	//}
//
//	//res, err := resolver.ExternalLookup(&q, "")
//	//assert.Nil(t, err)
//	//verifyCombinedResult(t, res.Data.(CombinedResults).Results, expectedRes)
//
//	res, _, status, _ := nsMod.Lookup(resolver, "example.com", ns1)
//	assert.Equal(t, len(res.(NSResult).Servers), 0)
//	assert.Equal(t, status, protocolStatus[domain_ns_1])
//}
...
// //		assert.Nil(t, err)
// //
// //		ns1 := net.JoinHostPort(externalNameServers[0], "53")
// //		domain1 := "example.com"
// //		ns_domain1 := "ns1.example.com"
// //		ipv4_1 := "192.0.2.1"
// //		ipv4_2 := "192.0.2.2"
